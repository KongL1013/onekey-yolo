...
class configer():
    def __init__(self):
        ...
        self.mode = mode[0]  # 三种模式:训练，测试，接着上次的继续训练

        self.test_pic_path = '/home/dd/darknet/data/yolo_data/pic/11.jpg'  # 如果是测试模式，请输入测试图片地址
        self.testing_weight_path = '/home/dd/darknet/backup/yolov3-tiny_800.weights'  # 测试模式的权重地址，在darknet/backup文件夹下，保存有训练权重结果
